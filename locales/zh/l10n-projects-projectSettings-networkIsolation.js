...
module.exports = {
  // Banner
  NETWORK_ISOLATION_DESC: '通过配置网络隔离控制同一工作空间容器组之间的流量以及来自外部的流量，从而实现隔离应用并增强应用的安全性。',
  ...
  INTERNAL_ALLOWLIST_TIP: '将工作空间内部的项目和服务添加到白名单。',
  INTERNAL_EGRESS_DESC: '当前项目中的容器组可以访问以下服务和项目的容器组。',
  INTERNAL_INGRESS_DESC: '当前项目中的容器组可以被以下服务和项目的容器组访问。',
  INTERNAL_ALLOWLIST_DESC: '允许当前项目中的容器组与当前工作空间其他项目中的服务进行通信。',
  EMPTY_RESOURCE_DESC: '请选择至少一个项目或服务。',
  // Network Isolation > External Allowlist
  EXTERNAL_ALLOWLIST: '外部白名单',
  EXTERNAL_ALLOWLIST_TIP: '将工作空间外部的网段和端口添加到白名单。',
  EXTERNAL_ALLOWLIST_DESC: '允许当前项目中的容器组与工作空间外部的特定网段和端口进行通信。',
  ...
  EXTERNAL_TRAFFIC_DIRECTION_DESC: '出站表示从当前项目到工作空间外的方向。入站表示从工作空间外到当前项目的方向。',
