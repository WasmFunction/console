...
module.exports = {
  ...
  ROLE_WORKSPACES_MANAGER: '管理 KubeSphere 平台上的所有工作空间。',
  ROLE_PLATFORM_ADMIN: '管理 KubeSphere 平台上的所有资源。',
  ROLE_PLATFORM_REGULAR: '被邀请加入工作空间之前无法访问任何资源。',
  ROLE_PLATFORM_SELF_PROVISIONER: '创建工作空间并成为所创建的工作空间的管理员。',
  ...
  PERMISSION_WORKSPACES_VIEW: '工作空间查看',
  PERMISSION_WORKSPACES_VIEW_DESC: '查看工作空间。',
  PERMISSION_WORKSPACES_MANAGEMENT: '工作空间管理',
  PERMISSION_WORKSPACES_MANAGEMENT_DESC: '创建、编辑和删除工作空间。',
  PERMISSION_WORKSPACES_CREATE: '工作空间创建',
  PERMISSION_WORKSPACES_CREATE_DESC: '创建工作空间并成为所创建的工作空间的管理员。',
