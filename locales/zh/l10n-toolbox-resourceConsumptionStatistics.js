...
module.exports = {
  ...
  CURRENT_RESOURCE_CONSUMPTION: '当前资源消费情况',
  VIEW: '查看',
  CONSUMPTION_SINCE_CREATION: '自创建以来已消耗了以下资源。',
  PRICE: '价格',
  // Workspace Recource Consumption
  WORKSPACE_CONSUMPTION: '工作空间资源消费情况',
  WORKSPACE_CONSUMPTION_DESC: '查看工作空间的资源消费情况。',
  WORKSPACE_RESOURCE_CONSUMPTION_DESC: '<strong>工作空间</strong>的 CPU、内存、卷等资源的消费情况',
  WORKSPACE_PROJECT_CONSUMPTION_DESC: '工作空间中<strong>项目</strong>的 CPU、内存、卷等资源的消费情况',
  PROJECT_CONSUMPTION_DESC: '项目中的<strong>应用</strong>、<strong>服务</strong>、<strong>容器组</strong>的 CPU、内存、卷等资源的消费情况'
};