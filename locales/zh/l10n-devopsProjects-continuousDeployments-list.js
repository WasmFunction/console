...
module.exports = {
  ...
  SELF_HEAL_DESC: '如果勾选，当检测到 Git 仓库中定义的状态与部署资源中有偏差时，将强制应用 Git 仓库中的定义。不勾选时，对部署资源做更改时不会触发自动同步。',
  FOREGROUND_DESC: '先删除依赖资源，再删除主资源。',
  BACKGROUND_DESC: '先删除主资源，再删除依赖资源。',
  ORPHAN_DESC: '删除主资源，留下依赖资源成为孤儿。',
  SKIP_SCHEMA_VALIDATION_DESC: '跳过 kubectl 验证。执行 kubectl apply 时，增加 --validate=false 标识。',
